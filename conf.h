...
public:
	...
	//v206 (1.0.8)
	int match_discogs_artwork_index_width = MAKELPARAM(HDF_CENTER * 10 + 6, 30);    //justify mode*10 + index, def width
	int match_file_artwork_index_width    = MAKELPARAM(HDF_CENTER *10 + 3, 30);     //justify mode*10 + index, def width
