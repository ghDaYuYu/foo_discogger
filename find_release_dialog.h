...
#pragma warning( disable : 26454 )
	...
	BEGIN_MSG_MAP(CFindReleaseDialog)
		...
		COMMAND_ID_HANDLER(IDC_PROCESS_RELEASE_BUTTON, OnButtonNext)
		COMMAND_ID_HANDLER(IDC_ONLY_EXACT_MATCHES_CHECK, OnCheckboxOnlyExactMatches)
		COMMAND_ID_HANDLER(IDC_CHECK_FIND_RELEASE_SHOW_PROFILE, OnCheckboxBindProfilePanel)
...
// capture WM_GETDLGCODE VKRETURN
