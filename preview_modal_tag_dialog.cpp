...
LRESULT CPreviewModalTagDialog::OnInitDialog(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/) {
	...
	// get size of the inner part of the tab control
	RECT rcTab;
...
void CPreviewModalTagDialog::ReloadItem(HWND p_parent, size_t item, PreView parent_preview_mode) {
	
	m_isel = item;

	if (parent_preview_mode != PreView::kUndef) {
...
LRESULT CPreviewModalTagDialog::OnApply(WORD /*wNotifyCode*/, WORD wID, HWND /*hWndCtl*/, BOOL& /*bHandled*/) {
...
bool CPreviewModalTagDialog::context_menu_switch(HWND wnd, POINT point, bool is_files, int cmd, bit_array_bittable selmask /*, CListControlOwnerData* ilist*/ ) {
	...
	case ID_CMD_EDIT:
		...
		((ILOD_preview_modal*)this)->trigger_action();
		return true;
	case ID_CMD_COPY: {
